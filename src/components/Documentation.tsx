...
} from "@/lib/templateDocumentationData";
...
function CodeBlock({ children }: { children: string }) {
  return (
    <pre className="mt-3 rounded-lg border bg-muted/50 p-3 text-xs overflow-x-auto sm:text-sm">
      <code className="text-foreground whitespace-pre font-mono">{children}</code>
    </pre>
  );
}
          ...
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-6 lg:items-start">
              ...
              <CardContent className="space-y-3 pt-0 text-sm text-muted-foreground">
                <ul className="list-disc space-y-1.5 pl-4 text-xs sm:text-sm">
                  <li>
                    ...
                    <strong className="text-foreground">PascalCase</strong> name;
                    first match wins.
                  </li>
                  <li>
                    No{" "}
                  ...
                  <li>
                    <strong className="text-foreground">Generate Preview</strong>{" "}
                    renders with{" "}
                    <code className="rounded bg-muted px-1 py-0.5 text-[11px]">
                      {"{}"}
                    </code>{" "}
            ...
            <Card className="shadow-sm">
              <CardHeader className="flex flex-row flex-wrap items-center justify-between gap-2 space-y-0 pb-3">
                <CardTitle className="text-base">React Email primitives</CardTitle>
                <a
            ...
            <Card className="shadow-sm">
              <CardHeader className="space-y-0 pb-3">
                <CardTitle className="text-base">Global assets</CardTitle>
              </CardHeader>
              <CardContent className="space-y-2 pt-0 text-xs sm:text-sm">
                {templateAssetGlobals.map((asset) => (
                  ...
                  >
                    ...
                    <span className="text-foreground">{asset.url}</span>
            ...
            <Card className="shadow-sm">
              <CardHeader className="space-y-0 pb-3">
                <CardTitle className="text-base">App components</CardTitle>
              </CardHeader>
            ...
            <p className="rounded-lg border border-dashed border-border bg-muted/20 px-3 py-2.5 text-center text-xs text-muted-foreground lg:col-span-2 sm:text-sm">
              <span className="font-medium text-foreground">React</span> is
              injected for JSX (classic runtime)—no import.
            </p>
          </div>
        </div>
      </ScrollArea>
