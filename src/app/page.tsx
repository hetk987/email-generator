    ...
    const generateHtml = async () => {
        ...
        try {
            ...
            try {
                ...
                // Babel can return without `code` in edge cases; fall back so matchAll never runs on undefined.
                transformedCode =
                    typeof result?.code === "string" ? result.code : code;
            } catch (babelError) {
          ...
          <div className="flex items-center justify-between">
            ...
            <main className="flex-1 min-h-0">
                ...
                >
                    ...
                    <TabsContent
                        value="editor"
                        className="flex-0 min-h-11 mt-0 px-4 pb-4"
                    >
                        <ResizablePanels
                            leftPanel={
                                <CodeEditor
